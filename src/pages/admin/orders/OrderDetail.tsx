...
const OrderDetail: React.FC = () => {
    ...
    useEffect(() => {
        const fetchOrderDetail = async () => {
            try {
                ...
                if (!response.ok) {
                    throw new Error(
                        `Không thể tải thông tin đơn hàng: ${response.status} ${response.statusText}`,
                    );
                }
    ...
    const handleUpdateStatus = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(
                    `Không thể cập nhật trạng thái đơn hàng: ${response.status} ${response.statusText}`,
                );
            }
        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="flex justify-center items-center h-64">
                    <div
                        className="inline-block h-12 w-12 animate-spin rounded-full border-4 border-solid border-current border-r-transparent text-blue-600 motion-reduce:animate-[spin_1.5s_linear_infinite]"
                        role="status"
                    >
                ...
                <div className="bg-white p-6 rounded-lg shadow-md col-span-2">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <span
                                className={`px-3 py-1 text-xs font-semibold rounded-full inline-block ${getStatusClass(
                                    order.status,
                                )}`}
                            >
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 max-w-md w-full">
                        ...
                        {actionType === 'cancel' ? (
                            ...
                            <p className="mb-4">
                                Bạn có chắc chắn muốn cập nhật trạng thái đơn
                                hàng từ
