...
export default function BestSellingPage() {
  ...
  const exportToPDF = () => {
    ...
    // Định nghĩa period
    const period = timeRange === 'week' ? 'Tuần' : timeRange === 'month' ? 'Tháng' : 'Năm';
    ...
    const sortedProductsRevenue = [...filteredProducts].sort((a, b) => b.revenue - a.revenue);
    ...
    const tableBody = top10Products.map((product, index) => {
      ...
      return [
        ...
        { text: trendSymbol, color: trendColor, alignment: 'center', bold: true }
      ];
    });
                  ...
                  columns: [
                    ...
                    // Thông tin
                    {
                      stack: [
                        ...
                        {
                          text: totalSold.toString() + ' sản phẩm',
                          fontSize: 18,
                          bold: true,
                          color: colors.secondary
                        }
                      ...
                      columns: [
                        {
                          stack: [
                            ...
                            {
                              text: bestSellingProduct.name.length > 25
                                ? bestSellingProduct.name.substring(0, 22) + '...'
                            ...
                            },
                            {
                              columns: [
                                ...
                                {
                                  text: formatCurrency(bestSellingProduct.revenue),
                                  fontSize: 10,
                                  color: colors.success,
                                  alignment: 'right',
                                  width: '*'
                      ...
                      columns: [
                        {
                          stack: [
                            ...
                            {
                              text: bestRevenueProduct.name.length > 25
                                ? bestRevenueProduct.name.substring(0, 22) + '...'
                            ...
                            },
                            {
                              columns: [
                                ...
                                {
                                  text: formatCurrency(bestRevenueProduct.revenue),
                                  fontSize: 10,
                                  color: colors.success,
                                  alignment: 'right',
                                  width: '*'
                    ...
                    stack: [
                      {
                        columns: [
                          ...
                          {
                            text: formatCurrency(category.revenue),
                            fontSize: 10,
                            alignment: 'right',
                            width: 80
                          }
                      ...
                      },
                      {
                        canvas: [
                          ...
                          },
                          {
                            ...
                            x: 0,
                            y: 0,
                            w: Math.min(250 * (category.revenue / topCategories[0].revenue), 250),
                            h: 10,
                            r: 5,
          ...
          stack: [
            ...
            },
            {
              ...
              layout: {
                ...
                paddingLeft: function (i: any) { return 8; },
                paddingRight: function (i: any) { return 8; },
                paddingTop: function (i: any) { return 6; },
                paddingBottom: function (i: any) { return 6; }
              }
            }
          ]
        },
    ...
    pdfMake.createPdf(docDefinition).download(`bao-cao-san-pham-ban-chay-${period.toLowerCase()}.pdf`);
  };
  const exportToExcel = () => {
