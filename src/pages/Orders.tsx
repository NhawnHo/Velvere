...
function Orders() {
    ...
    const refreshOrders = async () => {
        try {
            ...
            if (selectedOrder) {
                const updatedOrder = sortedOrders.find(order => order._id === selectedOrder._id);
                if (updatedOrder) {
    ...
    const handleCancelOrder = async () => {
        ...
        if (selectedOrder.status !== 'pending' && selectedOrder.status !== 'confirmed') {
            setDialog({
                ...
                description: 'Đơn hàng đã được giao hoặc đang trong quá trình vận chuyển nên không thể hủy.',
                type: 'error',
            });
            return;
        }
        ...
        try {
            ...
            await axios.put(`http://localhost:3000/api/orders/${selectedOrder._id}/cancel`);
    ...
    const handleReorder = async () => {
        ...
        try {
            ...
            setDialog({
                ...
                description: 'Đã xảy ra lỗi khi thêm sản phẩm vào giỏ hàng. Vui lòng thử lại sau.',
                type: 'error',
            });
        } finally {
            setProcessingAction(false);
        ...
        return (
            <div className="container mx-auto my-20 py-8 px-4 text-center">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <h2 className="text-xl font-semibold mb-2">Đang tải đơn hàng...</h2>
                </div>
            </div>
        );
    }
            ...
            <div className="container mx-auto my-20 py-8 px-4 max-w-5xl">
                <div className="bg-white border rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="flex justify-between items-center p-6 border-b">
                        <div>
                            <h1 className="text-2xl font-semibold">Chi tiết đơn hàng #{selectedOrder.order_id}</h1>
                            <p className="text-gray-500">Đặt ngày {formatDate(selectedOrder.orderDate)}</p>
                        </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="bg-gray-50 rounded p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <p className="text-gray-500 text-sm">Ngày giao hàng dự kiến</p>
                        ...
                        <div className="border-t pt-4">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-xl font-semibold">{selectedOrder.totalAmount.toLocaleString()}₫</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex flex-wrap justify-center gap-4">
                            ...
                            {(selectedOrder.status === 'pending' || selectedOrder.status === 'confirmed') && (
                                ...
                                >
                                    {processingAction ? 'Đang xử lý...' : 'Hủy đơn hàng'}
                                </button>
                            )}
